...
namespace ProcessCtl
{
    ...
    {
        private delegate void DlgtRefreshDisp();
        #region 私有数据
       ...
       // private Size canvasSize = new Size(100, 100);//大小
        ...
        {
            if(this.labelDetail.InvokeRequired)
            {
                DlgtRefreshDisp dlgtRefreshDisp = new DlgtRefreshDisp(RefreshDisp);
                this.Invoke(dlgtRefreshDisp);
            }
            else
            {
