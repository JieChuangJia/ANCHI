...
namespace MesDBAccess.DAL
{
    ...
    public partial class ProcessStepDal
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string processStepID)
        {
        ...
        public bool Add(MesDBAccess.Model.ProcessStepModel model)
        {
            ...
            strSql.Append("processSeq,processStepID,processStepName,stepCata,tag1,tag2,tag3,tag4,tag5)");
            ...
            parameters[1].Value = model.processStepID;
        ...
        /// 删除一条数据
        /// </summary>
        public bool Delete(string processStepID)
        {
        ...
        /// 批量删除数据
        /// </summary>
        public bool DeleteList(string processStepIDlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ProcessStep ");
            strSql.Append(" where processStepID in (" + processStepIDlist + ")  ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select processSeq,processStepID,processStepName,stepCata,tag1,tag2,tag3,tag4,tag5 ");
