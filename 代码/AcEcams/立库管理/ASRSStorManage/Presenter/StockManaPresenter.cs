...
namespace ASRSStorManage.Presenter
{
    public class StockManaPresenter
    {
        ...
        public void QueryStock(string houseName, string houseArea,string rowth, string colth, string layerth, string gsStatus, string gsTaskSta,string proBatch)
        {
            DataTable stockView = bllViewStock.GetData(houseName,houseArea, rowth, colth, layerth, gsStatus, gsTaskSta, proBatch);
