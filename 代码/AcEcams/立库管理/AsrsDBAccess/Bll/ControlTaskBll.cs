...
using System.Text;
using System.Data;
using AsrsDBAccess.Model;
namespace AsrsDBAccess.BLL
{/// <summary>
    /// 控制任务表
    /// </summary>
    public partial class ControlTaskBll
    {
        private readonly AsrsDBAccess.Dal.ControlTaskDal dal = new AsrsDBAccess.Dal.ControlTaskDal();
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(AsrsDBAccess.Model.ControlTaskModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(AsrsDBAccess.Model.ControlTaskModel model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public AsrsDBAccess.Model.ControlTaskModel GetModel(string TaskID)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<AsrsDBAccess.Model.ControlTaskModel> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<AsrsDBAccess.Model.ControlTaskModel> DataTableToList(DataTable dt)
        {
            List<AsrsDBAccess.Model.ControlTaskModel> modelList = new List<AsrsDBAccess.Model.ControlTaskModel>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                AsrsDBAccess.Model.ControlTaskModel model;
        ...
        public ControlTaskModel GetRunningTask(string strWhere)
        {
