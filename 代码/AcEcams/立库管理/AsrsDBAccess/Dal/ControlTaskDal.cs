...
{/// <summary>
    ...
    public partial class ControlTaskDal
    {
        ...
        public AsrsDBAccess.Model.ControlTaskModel GetModel(string TaskID)
        {
            ...
            AsrsDBAccess.Model.ControlTaskModel model = new AsrsDBAccess.Model.ControlTaskModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public AsrsDBAccess.Model.ControlTaskModel DataRowToModel(DataRow row)
        {
            AsrsDBAccess.Model.ControlTaskModel model = new AsrsDBAccess.Model.ControlTaskModel();
            if (row != null)
            {
