...
namespace CommonPL.Login
{
    public partial class LoginView : Form,ILoginView
    {
        ...
        {
            InitializeComponent();
            string jxDB = string.Format("Data Source ={0};Initial Catalog=FangTAIZaojuA;User ID=sa;Password=123456;", ConfigurationManager.AppSettings["DBConn"]);
            FTDataAccess.DBUtility.PubConstant.ConnectionString = jxDB;
        }
